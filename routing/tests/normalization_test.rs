...
fn test_previous_buckets_less_k_next_buckets_upto_k() {
    ...
    assert_eq!(old_normalize_rt.buckets[1].records[2].cid, "0111");
    assert_eq!(old_normalize_rt.buckets[1].records[3].cid, "0110");
...
fn test_next_bucket_more_than_k_choose_full_subbuckets() {
    ...
    assert_eq!(old_normalize_rt.buckets[1].records[3].cid, "0100");
